...
// Creates a 'Planet' component that renders a planet card
const Planet = (props) => {
  return (
    <div className="card">
      <div>
...
// Create a container component that iterates over the planets array
  ...
  return (
    <div className="container">
      {props.planets.map( planet =>
        <Planet
          // could use spread operator as well
          // {...planet}
          name={planet.name}
...
// Renders the container component to the DOM
